...
- `pivot_longer`: Takes several columns and gathers them into two columns. One of the new columns contains the former column names and the other contains the former cell values.
- `pivot_wider`: Takes two columns and spreads them into multiple columns. Column names for the new columns will come from one column and the cell values from the other.

The following examples are from `tidyr` help files and show the effects of making a dataset longer or wider.
