...
```
```{r echo = FALSE}
list.files("~/RProgrammingForResearch/data")
```
...
- Is there a way to read the "ld\_genetics.txt" file in using `read.table()` and specific options? If so, try to read the data in using that function.
