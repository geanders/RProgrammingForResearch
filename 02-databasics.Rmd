...
<iframe width="652" height="367" src="https://www.youtube.com/embed/DO5f5R4qW1s" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
...
```{block, type = 'rmdtip'}
If `readr` doesn't guess some of the columns classes you can use the `type_convert()` function to take another go at guessing them after you've tweaked the formats of the rogue columns.
```
