...
For `hist()`, the main aesthetic is `x`, the (numeric) vector for which you want to create a histogram:
...
You can try out some of the options on the histogram, like `main`, `xlab`, and `xlim`:
...
You can also perform most of these tasks using `dplyr`:
