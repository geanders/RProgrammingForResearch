...
And just for fun we cando the same thing with a different dataset:
...
We'd like to see which variable best predicts pace.
...
We can create a model function and regress each variabl using `nest()`:
