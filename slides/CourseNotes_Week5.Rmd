...
- Indent with two spaces, not a tab or a mix of tabs and spaces. 
- Exception: Line up new lines with first letter after opening parenthesis for parameters to function calls:
...
R Markdown can also be used to make presentations, including with: 
