...
tea_sims <- tibble(n_cups, perc_all_right)
...
tea_table <- tibble(` ` = c("Really milk", "Really tea", "Total"),
...
```{r}
analytical_results <- tibble(n_cups = seq(2, 14, 2)) %>%
...
```{r echo = FALSE}
precip_dir <- "~/Documents/r_packages/hurricaneexposuredata/data-raw/"
```
