...
All require a *compiler* (e.g., gcc) on your computer to compile the code. You can get what you need with: 
...
The `sparklyr` package was just released by RStudio earlier this fall: http://spark.rstudio.com. \bigskip
...
precip_dir <- "~/Documents/CSU2016/hurricaneproject/hurricaneexposuredata/data-raw/"
```
...
```{r echo = FALSE, warning = FALSE, message = FALSE, fig.width = 8, eval = FALSE}
library(dplyr)
...
```{r echo = FALSE, fig.width = 8, eval = FALSE}
library(dplyr)
...
```{r echo = FALSE, out.width = "0.8\\textwidth", fig.align = "center", eval = FALSE}
