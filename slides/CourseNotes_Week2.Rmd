...
We'll take another break here to work on the next part of the In-Course Exercise (Section 2.7.1 and 2.7.2).
...
There are a few abbreviations you can use to represent certain relative locations when you're using `setwd()`:
...
We'll take a break now to do the first part of the in-course exercise (Sections 2.7.3).
