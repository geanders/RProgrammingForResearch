...
You will also see code that uses functions like `read.csv` and `read.table` to read in flat files. These are from base R. The `readr` functions are very similar, but have some more sensible defaults, including in determining column classes. \medskip
