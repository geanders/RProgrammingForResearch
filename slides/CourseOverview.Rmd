...
3.  (Optional) **Live Office Hours.** Synchronous meetings to ask
    questions about course material, homework, etc. (about 3 hours per
    week)
...
-   Time: Mondays and Wednesdays 10:00 am--11:00 am
...
Optional live office hours will be from 11:00 AM--noon.
...
```{r fig.align = "center", out.width = "300pt", echo = FALSE}
knitr::include_graphics("../figures/find_vocab_nodate.jpg")
```
...
-   Wednesday, Aug. 30, during class: First in-class quiz. The
...
-   Monday, Sept. 11: First homework is due by midnight by email.
