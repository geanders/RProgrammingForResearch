...
Homeworks #4 and #5 are now up. Both: 

- Use the same dataset (homicides in 50 U.S. cities)
- Require submitting through GitHub

Homework #4 will be done individually, while Homework #5 will be done in groups. 
Groups for Homework #5 will be assigned next Wednesday (Oct. 31).

For today's and Monday's in-course exercise, we will start setting up your GitHub repository for 
these homeworks. 

## Group projects

This year, our topic for the group projects will be West Nile virus. 

You will work in groups on the final project, and different groups can use different 
sets of data related to this topic. 

Between now and next Wednesday (Oct. 31), see what available data you can find related to
West Nile virus. If you find data you would like to work with in a group, or a research 
question you would like to explore, bring a few notes in on the data / idea for next
Wednesday. 
...
knitr::include_graphics("../_book/figures/GitCartoon1.png")
```

## git

```{r echo = FALSE, out.width = "0.5\\textwidth", fig.align = "center"}
knitr::include_graphics("../_book/figures/FileSystemCartoon.jpg")
```
Source: PhDComics
...
```{r echo = FALSE, out.width = "\\textwidth", fig.align = "center"}
knitr::include_graphics("../_book/figures/git_commit.png")
```
Source: xkcd
...
```{r echo = FALSE, out.width = "0.8\\textwidth", fig.align = "center"}
knitr::include_graphics("../_book/figures/GitHubDiagram.png")
```
Source: GitHub
...
knitr::include_graphics("../_book/figures/GitCartoon2.png")
```
Source: xkcd
