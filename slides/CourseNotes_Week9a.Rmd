...
## Mapping an `sf` object

## Getting U.S. geography for `sf` objects

## Building maps with multiple components

## `ggplot` tricks with `sf` objects

## `dplyr` tricks with `sf` objects
...
- Writing a function
- Applying it across many facets of the data
- Plotting or mapping the result of the analysis