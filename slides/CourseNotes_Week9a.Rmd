...
Before Wednesday's class, be sure to do the following: 

- Register for GitHub: https://github.com
- Download and install git: https://git-scm.com 
- Install LaTeX: MikTeX for Windows, MacTeX for Macs. If you have low memory on your computer, you 
may want to start with "TinyTex" (https://yihui.name/tinytex/) instead
...
Note: You may need the development version of `ggplot2` for this to work (`devtools::install_github("tidyverse/ggplot2")`).
