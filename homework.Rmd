...
- `nxt()`: regain swirl's attention after `play()`ing around in the console. - `bye()`: exit swirl. Swirl will save your progress if you exit in the middle of a lesson. (To re-enter swirl, run `swirl()`. In a new session you will have to first load the swirl library: `library(swirl)`.)
