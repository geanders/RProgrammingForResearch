...
Next, load the swirl package. We're going to download a course from swirl's [course repository](https://github.com/swirldev/swirl_courses) called R Programming Alt using the function `install_course_github`. Then call the `swirl()` function to enter the interactive platform: 
