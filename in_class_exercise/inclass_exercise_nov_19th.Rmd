...
```{r, eval=TRUE, fig.align='center', fig.width=3}
knitr::include_graphics("../figures/race_fig.png")
```
...
* download the data from [google drive](https://drive.google.com/drive/folders/1GetpmInzi382-LcaCvyn6d2CrePQEbBs?usp=sharing)
