...
## Quiz 1---R Preliminaries (Updated for 2018)
...
## Quiz 2---Entering / cleaning data #1 (Updated for 2018)
...
## Quiz 5 (Updated for 2018; no updates since last week)
...
## Quiz 6 (Updated for 2018; no updates since last week)
...
## Quiz 7 (Updated for 2018; no updates since last week)
...
## Quiz 8 (Updated for 2018)

- Matrices and lists
- From `ggplot2`: `geom_text`, `geom_label`, and `geom_tile`
- ggplot extensions, including `scales` and `ggrepel`
- Purpose of `assertive` package
- `if` / `else` structures (especially in code for a function)
- `map` family of functions (e.g., `map`, `map_df`, `pmap`)
