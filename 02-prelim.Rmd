...
```{r toy-train-basic, echo = FALSE, out.width = "400pt", fig.cap = "The toy version of base R."}
...
```{r toy-train-fancy, echo = FALSE, out.width = "800pt", fig.cap = "The toy version of what your R set-up will look like once you find cool packages to use for your research."}
