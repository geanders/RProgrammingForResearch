...
<!--chapter:end:02-databasics.Rmd-->


# Exploring data #1

<!--chapter:end:03-exploringdata1.Rmd-->


# Reporting data results #1

<!--chapter:end:04-reportingresults1.Rmd-->


# Reproducible research #1

<!--chapter:end:05-reproducibleresearch1.Rmd-->


# (PART) Part III: Intermediate {-}

<!--chapter:end:06-databasics2.Rmd-->


# Exploring data #2

<!--chapter:end:07-exploringdata2.Rmd-->


# Reporting data results #2

<!--chapter:end:08-reportingresults2.Rmd-->


# Reproducible research #2

<!--chapter:end:09-reproducibleresearch2.Rmd-->


# (PART) Part IV: Advanced {-}

<!--chapter:end:10-gettingcleaningdata3.Rmd-->
...
<!--chapter:end:11-exploringdata3.Rmd-->
