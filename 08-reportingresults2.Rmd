...
```{r ccy, message = FALSE, warning = FALSE, fig.width = 4, fig.height = 2.75, fig.align = "center", echo = FALSE}
map_fatal_accidents(accident, which_state = "Colorado")
```

```{r ccz, message = FALSE, warning = FALSE, fig.width = 4.3, fig.height = 4.5, fig.align = "center", echo = FALSE}
