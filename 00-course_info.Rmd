...
This document provides the course notes for Colorado State University's ERHS 535 course for Fall 2017. The course offers in-depth instruction on data collection, data management, programming, and visualization, using data examples relevant to academic research.
...
- If we have any course meetings outside of our regular course time (M/W 10:00 AM--12:00 PM) to make up for dates when I am travelling, attendance will be optional.
