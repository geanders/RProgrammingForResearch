...
```{r echo = TRUE, fig.width = 8, fig.height = 2.5}
top_player <- worldcup %>% 
  top_n(n = 1, wt = Shots) %>% 
  mutate(label = paste0(Player, ", ", Team))
...
<iframe width="747" height="467" src="https://www.youtube.com/embed/xEtJngvw5SA?list=PLuGPtwgRXxqKjAaAEy3fSjRSTHIeeYacx" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
