...
%\chead{ \fancyplain{}{} }
\rhead{ \fancyplain{}{August 25, 2025} }
...
\textbf{Instructor:} Brooke Anderson (001)/ \\ Andreas Neophytou (002) & & &  & \textbf{Time:} & M/W 10:00 am -- 12:00 pm \\
\textbf{Email:}  \href{mailto:brooke.anderson@colostate.edu}{brooke.anderson@colostate.edu}/ \\ \href{mailto:andreas.neophytou@colostate.edu}{andreas.neophytou@colostate.edu} & & & & \textbf{Place:} & MRB 463 (001)/ Walnut 101 (002)
\end{tabular}
\end{minipage}
\rule{7in}{0.4pt}
\end{center}
...
\vskip.15in
\noindent\textbf{Time and place:}  This course meets in Room 463 of MRB (Walnut 101 for section 002) on Mondays and Wednesdays, 10:00 am--11:50 am. Exceptions to these meeting times are: 
...
\item If you miss classes for ``University-sanctioned'' activities. These can include attending a conference, travel to collect data for your dissertation), For these absences, you must inform me prior to the date that you will be absence. No points will be lost for attendance if you provide a signed letter from your research advisor, or an email that copies your advisor, by the start of finals week, and you can make arrangements with me to make up any missed work. For more details, see CSU's Academic Policies on Course Attendance (\url{http://catalog.colostate.edu/general-catalog/academic-standards/academic-policies/}).
\item If you have to miss class for a serious medical issue (e.g., operation, sickness severe enough to require a doctor's visit), the absence will be excused.
\end{itemize}
...
\item Various books on bookdown.org (\url{https://bookdown.org/})
\end{itemize}
