...
```{r echo = FALSE}
plot_funcs <- data.frame(type = c("Histogram",
                                  "Scatterplot",
                                  "Boxplot"), 
                         aes = c("one numeric variable",
                                 "two numeric variables",
                                 "one numeric variable, possibly stratified by a factor variable"),
...
The following options will work in many of the `ggplot2` geoms plotting functions:
...
plot_opts <- data.frame(opt = c("`color`", "`fill`",
                        ...
                        desc = c("Color of a plotting element",
                                 ...
                                 "Type of line to use (e.g., solid, dashed)",
                                 "Transparency (closer to 1 for more opaque, closer to 0 for more transparent)"))
